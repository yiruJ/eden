...
export function TiltedCard({
  ...
  return (
    ...
    >
      {showMobileWarning && (
        <div className="absolute top-4 text-center text-sm block sm:hidden text-charcoal/50">
      ...
      >
        <motion.img
          src={imageSrc}
          alt={altText}
          className="absolute top-0 left-0 object-cover object-top rounded-2xl will-change-transform [transform:translateZ(0)]"
